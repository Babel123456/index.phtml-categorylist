        ...
        init: function (options) {
            ...
            if ($('#css-ddslick').length <= 0) {
                var ddslickCSS = '<style id="css-ddslick" type="text/css">' +
                                        '.dd-select{ border-radius:1px; border:solid 1px #ccc; position:relative; cursor:pointer;}' +
                                        ...
                                        '.dd-option{ padding:5px; display:block; border-bottom:solid 1px #ddd; overflow:hidden; text-decoration:none; color:#333; box-sizing:border-box;cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; }' +
                                        '.dd-options > li:last-child > .dd-option{ border-bottom:none;}' +
                                        '.dd-option:hover{ background:#f3f3f3; color:#000;}' +
                                        '.dd-selected-description-truncated { text-overflow: ellipsis; white-space:nowrap; }' +
                                        '.dd-option-selected { background:#fffff; }' +
