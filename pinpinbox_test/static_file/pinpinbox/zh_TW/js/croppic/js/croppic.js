...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		initCropper: function(){
			...
			that.img.wrap('<div class="cropImgWrapper" style="overflow:hidden; z-index:12; position:absolute; width:'+that.objW+'px; height:'+that.objH+'px;"></div>');
		...
		createCropControls: function(){
	        ...
	        var cropControlCrop =            '<i class="cropControlCrop" style="display:none;"></i>';
