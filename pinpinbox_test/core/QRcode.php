...
class QRcode {
	...
	function getBase64() {
		ob_start();
		\QRcode::png($this->text, null, $this->level_target, $this->size_target, $this->margin_target);//2016-12-14 Lion: 第 2 個參數要為 null, 才不用以 header('Content-Type: text/html') 補正而確切輸出字串
